...
"accommodation" => "4 Star Accommodation",
"transport" => "AC Vehicle with Driver",
"meals" => "Breakfast Included",
"catch_line" => "Experience India's most iconic circuit in luxury and comfort",
"is_popular" => true
],
[
"id" => 2,
...
"route" => "Jaipur - Jodhpur - Udaipur - Pushkar",
"accommodation" => "Heritage Stay Experience",
"transport" => "Luxury AC Vehicle",
"inclusions" => "Cultural Shows Included",
"catch_line" => "Immerse yourself in the rich cultural tapestry of Rajasthan",
"is_popular" => false
],
[
"id" => 3,
...
"route" => "Jaisalmer Desert Camp",
"accommodation" => "Desert Camp Stay",
"activities" => "Camel Safari Included",
"experiences" => "Bonfire & Cultural Night",
"catch_line" => "Embark on an unforgettable desert adventure under the stars",
"is_popular" => true
],
[
"id" => 4,
"name" => "Royal Palaces Tour",
"duration" => "6 Days / 5 Nights",
"route" => "Jaipur - Udaipur - Jodhpur",
"accommodation" => "Palace Hotels",
"transport" => "Premium AC Vehicle",
"experiences" => "Private Guided Tours",
"catch_line" => "Live like royalty exploring majestic palaces and forts",
"is_popular" => false
],
[
"id" => 5,
...
"duration" => "5 Days / 4 Nights",
"route" => "Ranthambore - Bharatpur - Jaipur",
"accommodation" => "Jungle Lodge & Heritage Hotel",
"activities" => "Safari Experiences",
"transport" => "AC Vehicle with Expert Driver",
"catch_line" => "Discover Rajasthan's wild side with tiger spotting and bird watching",
"is_popular" => true
],
[
"id" => 6,
...
"duration" => "5 Days / 4 Nights",
"route" => "Pushkar - Ajmer - Jaipur",
"accommodation" => "Comfortable & Spiritual Stays",
"transport" => "AC Vehicle",
"experiences" => "Spiritual Guidance Included",
"catch_line" => "Find inner peace on a spiritual journey through sacred sites",
"is_popular" => false
]
];
