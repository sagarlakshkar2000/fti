        ...
        <div class="row align-items-center">
                ...
                <div id="heroTextCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <!-- CTA Button -->
                            <a href="#booking" class="btn btn-cta">Book Your Taxi Now</a>
                        </div>
            ...
            <div class="col-lg-6">
                <div id="heroImageCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://quickcabservicesjaipur.com/wp-content/uploads/2025/01/Kia-Carens.png"
                                alt="Kia Carens Taxi" class="d-block w-100 rounded-0 shadow-none">
                        </div>
                        <div class="carousel-item">
                            <img src="https://quickcabservicesjaipur.com/wp-content/uploads/2025/01/Maruti-ertiga-2.png"
                                alt="Maruti Ertiga Taxi" class="d-block w-100 rounded-0 shadow-none">
                        </div>
                        <div class="carousel-item">
                            <img src="https://quickcabservicesjaipur.com/wp-content/uploads/2025/01/Innova-1.png"
                ...
                <div class="col-lg-6 mb-4">
                    <div class="service-card">
                        ...
                        <div class="card-content">
                            ...
                            <a href="tel:+918107968806" class="btn-booking">
                    ...
                    <div class="bg-white p-4 rounded-3 shadow-sm">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-md-end">
                                <a href="#contact" class="btn btn-outline-primary px-4 rounded-pill">Enquire Now</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="cta-section py-5 text-center"
    ...
    <div class="container" style="background: rgba(234, 231, 231, 0.28); padding: 40px; border-radius: 15px;">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="tel:+911234567890" class="btn btn-light btn-lg text-primary fw-bold">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-card">
                        ...
                        <div class="package-content">
                            ...
                            <a href="#enquire" class="btn btn-outline-primary w-100">Enquire Now</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
